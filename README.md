...
1. **記事取得**: Yahoo!ニュースのRSSから最新記事を提示。9カテゴリ（主要、国内、国際、経済、エンタメ、スポーツ、IT、科学、地域）から最大200件を取得。URL入力でもスクレイプ可能。
...
6. **最新ニュース検索**: 専用ページ (`/latest-feed`) でRSSフィードからの記事をキーワード検索し、ページネーション機能で快適にブラウジング。
